    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ForeignKey(on_delete=models.CASCADE, related_name='posted_feed_items', to='profile.Profile')),
                ('recipient', models.ForeignKey(on_delete=models.CASCADE, related_name='received_feed_items', blank=True, to='profile.Profile', null=True)),
            ],
        ),
